...
def create_meta_csv(dataset_path, destination_path):
    ...
    flist = []
    # transform the dataset to 3 label DS(added)
...
if __name__ == "__main__":
    ...
    df, trn_df, tst_df = create_and_load_meta_csv_df(dataset_path, destination_path=destination_path,
                                                     randomize=randomize, split=0.99)
    print(df.describe())
